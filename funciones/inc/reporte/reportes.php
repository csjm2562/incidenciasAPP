  ...
  function cargaPagina(pagina) {
    var desde = pagina * itemsPorPagina;
		$.ajax({
			...
			type:"GET",
			dataType:"json",
			url:"funciones/inc/reporte/conexionReporte.php"
		}).done(function(data,textStatus,jqXHR) {
      var lista = data.lista;
			$("#tablaReportes").html("");
			$.each(lista, function(ind, elem){
  			$("<tr>"+
          "<td class='center'>"+elem.idReporte+"</td>"+
  				"<td class='center'>"+elem.usuario+"</td>"+
  				"<td class='center'>"+elem.tipo+"</td>"+
  				"<td class='center'>"+elem.fecha+"</td>"+
  				"<td class='center'>"+elem.descripcion+"</td>"+
